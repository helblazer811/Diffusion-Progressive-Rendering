...
class BatchedLCMScheduler(SchedulerMixin, ConfigMixin):
    """
    ...
    def step(
        ...
        # print(f"timestep: {timestep}, prev_timestep: {prev_timestep}")
        # print(f"Model out shape: {model_output.shape}, sample shape: {sample.shape}")
